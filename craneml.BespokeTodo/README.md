# Bespoke Todo Noteplan Plugin

## Latest Updates

See [CHANGELOG](https://github.com/NotePlan/plugins/blob/main/craneml.BespokeTodo/CHANGELOG.md) for latest updates/changes to this plugin.

## About This Plugin 

The exact way I like to see my todos
